...
const TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImJsaW1hIiwiaWQiOjEsImlhdCI6MTYwOTgxMDE1OX0.-FD30VCeEYnTc1f5zq59LTSxbMpKk_tDUl9HEyTjmNE"
...
describe("Tests API Heroes", function () {
  ...
  it("should list heroes with 10 registers", async () => {
    const LIMIT_SIZE = 2;
    const result = await app.inject({
      method: "GET",
